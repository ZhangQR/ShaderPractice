...
[ExecuteInEditMode]
public class GlobalFogWithNoise : MonoBehaviour
{
    ...
    [Range(0,3)]
    public float NoiseStrength = default;
    [Range(0,1)]
    public float SpeedX = default;
    [Range(0, 1)]
    public float SpeedY = default;
    ...
    private void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        if (GlobalFogMaterial != null)
        {
            ...
            GlobalFogMaterial.SetFloat("_SpeedX", SpeedX);
            GlobalFogMaterial.SetFloat("_SpeedY", SpeedY);
            GlobalFogMaterial.SetFloat("_NoiseStrength", NoiseStrength);
            GlobalFogMaterial.SetColor("_FogColor", FogColor);
            GlobalFogMaterial.SetTexture("_NoiseTexture", NoiseTexture);    
